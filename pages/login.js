...
const Login = () => {
  ...
  return (
    <main className="flex gap-8 flex-col justify-between items-center min-h-screen pt-20">
      ...
      <div className="w-[80%] md:w-[420px] text-center md:pt-10 md:pb-8 md:px-8 md:bg-white md:dark:bg-zinc-850 rounded-2xl md:shadow-2xl md:shadow-gray-200 md:dark:shadow-none">
        <div className="mb-8">
